...
describe("matchingFiles", () => {
	describe("when not negated", () => {
		...
		it("should find violations because not all edges are matching check pattern", () => {
			...
			const violations = gatherRegexMatchingViolations(edges, "b", ["good"], false)
			expect(violations).toEqual([{"checkPattern": "b", "projectedNode": {"label": "good/a"}}, {"checkPattern": "b", "projectedNode": {"label": "good/c"}}])
		})
	})
	...
	describe("when negated", () => {
		...
		it("should find violations because check pattern is matching", () => {
			...
			expect(violations).toEqual([{"checkPattern": "z", "projectedNode": {"label": "good/az"}}, {"checkPattern": "z", "projectedNode": {"label": "good/bz"}}, {"checkPattern": "z", "projectedNode": {"label": "good/cz"}}])
		})
